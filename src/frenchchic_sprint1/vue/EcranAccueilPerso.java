...
public class EcranAccueilPerso extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EcranAccueilPerso
     */
    public EcranAccueilPerso() {
        initComponents();
         
         this.jLabel2.setText("Bonjour "+Session.clientSession.getPrenom() + " " + Session.clientSession.getNom());
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(455, 337));
        ...
        jLabel3.setText("Le produit du jour est le \"pontalon zouk\" au pris  HT est de 50 €");
        ...
        jButton1.setText("Ajouter le produit du jour au panier");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                EcranAccueilPerso ecp=new EcranAccueilPerso();
                ecp.jLabel2.setText("Bonjour "+Session.clientSession.getNom() + " " + Session.clientSession.getPrenom());
                ecp.setVisible(true);
            }
        });
    }
